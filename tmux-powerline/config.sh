...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/jon/.mail/inbox/new"

	## mbox
	# Path to the mbox to check.
	export TMUX_POWERLINE_SEG_MAILCOUNT_MBOX_INBOX="/var/spool/mail/jon"

	## mailcheck
	# Optional path to mailcheckrc
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/jon/.mailcheckrc"
# }
...
# pwd.sh {
	...
	export TMUX_POWERLINE_SEG_PWD_MAX_LEN="60"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="44.836151"
	TMUX_POWERLINE_SEG_WEATHER_LON="-0.580816"
# }
